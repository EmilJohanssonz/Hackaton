      ...
      <div style={{ padding: '20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <OptionCard
            ...
            options={[
              {
                name: 'Erikslundskolan',
                url: 'https://www.erikslundskolan.se',
              },
              { name: 'Bodaskolan', url: 'https://www.bodaskolan.se' },
              { name: 'Daltorpskolan', url: 'https://www.daltorpskolan.se' },
              {
                name: 'Engelbreksskolan',
                url: 'https://www.engelbreksskolan.se',
              },
            ]}
          />
          ...
          <OptionCard
            ...
            options={[
              {
                name: 'Sven Eriksonsgymnasiet',
                url: 'https://www.boras.se/svenerikson',
              },
              {
                name: 'Bäckängsgymnasiet',
                url: 'https://www.boras.se/backang',
              },
          ...
          <OptionCard
            ...
            options={[
              ...
              {
                name: 'Borås Yrkeshögskola',
                url: 'https://www.boras.se/utbildningochforskola/yrkeshogskola.4.5c03c6f114b858fef800018827.html',
              },
            ]}
          />
        </div>
